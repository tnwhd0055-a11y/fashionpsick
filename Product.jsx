...
function Product({ nav, openProduct, productId }) {
  ...
  return (
    <div style={{ background: "var(--paper)" }}>
      ...
      <PageWrap style={{ paddingTop: "var(--space-2xl)", paddingBottom: "var(--space-5xl)" }}>
        <div style={{ display: "grid", gridTemplateColumns: "1.15fr 1fr", gap: "var(--space-4xl)", alignItems: "start" }}>
          {/* Gallery */}
          <div style={{ display: "grid", gridTemplateColumns: "72px 1fr", gap: "var(--space-md)" }}>
...
function ProductDetail() {
  ...
  return (
    <section style={{ background: "var(--paper)", borderTop: "var(--divider-hairline)" }}>
      <div style={{ maxWidth: 760, margin: "0 auto", padding: "var(--space-4xl) var(--gutter-page) var(--space-5xl)" }}>
